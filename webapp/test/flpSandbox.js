		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invocies List",
									"targetURL": "#logaligroupfacturas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupfacturas-display": {
								"semanticObject": "logaligroupfacturas",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.facturas",
									"url": sap.ui.require.toUrl("logaligroup/facturas")
								}
							}
						}
					}
